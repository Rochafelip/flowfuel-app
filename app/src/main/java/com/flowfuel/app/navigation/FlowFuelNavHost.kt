...
fun FlowFuelNavHost(
    ...
    // Exige sessão com veículo ativo (StartDestination.Home), pois não há
    // contexto de navegação válido para rotas internas em outros estados
    // (login/onboarding/picker).
